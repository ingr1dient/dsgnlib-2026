...
window.DS = {
  ...
  RAMPS: [
    ...
    { label: 'Background', tokens: [
      { name:'bg/100', hex:'#F5F6FA' },
      { name:'bg/200', hex:'#EDEEF5' },
      { name:'bg/300', hex:'#E5E7F0' },
      { name:'bg/400', hex:'#DDDFEC' },
      { name:'bg/500', hex:'#D5D8E7' },
    ]},
  ...
  SEM: [
    { g:'Backgrounds' },
    { n:'bg-page',          a:'bg/100',        h:'#F5F6FA', u:'Page background' },
    { n:'bg-subtle',        a:'bg/200',        h:'#EDEEF5', u:'Sidebars, subtle fills' },
    { n:'bg-muted',         a:'bg/300',        h:'#E5E7F0', u:'Disabled backgrounds' },
    { n:'bg-emphasis',      a:'bg/400',        h:'#DDDFEC', u:'Hover, selected rows' },
    { g:'Surfaces' },
    ...
    { n:'text-link',        a:'primary/400',   h:'#2882FF', u:'Hyperlinks' },
    { g:'Borders' },
    ...
    { n:'action-hover',     a:'primary/300',   h:'#93C5FD', u:'Hover state' },
    { n:'action-active',    a:'primary/500',   h:'#1D4ED8', u:'Pressed/active state' },
    { n:'action-disabled',  a:'neutral/200',   h:'#CCCCCC', u:'Disabled interactive' },
    { n:'action-subtle',    a:'primary/100',   h:'#EFF6FF', u:'Active nav bg, badge bg' },
    { g:'Status — Danger' },
    ...
    { g:'Status — Compliance Lifecycle (§4.7)' },
    { n:'status/compliant-bg',         a:'success/100', h:'#F0FDF4', u:'Compliant badge background' },
    { n:'status/compliant-text',       a:'success/500', h:'#15803D', u:'Compliant text' },
    { n:'status/compliant-border',     a:'success/400', h:'#16A34A', u:'Compliant border' },
    { n:'status/non-compliant-bg',     a:'danger/100',  h:'#FFE5E5', u:'Non-compliant background' },
    { n:'status/non-compliant-text',   a:'danger/500',  h:'#D70005', u:'Non-compliant text' },
    { n:'status/non-compliant-border', a:'danger/400',  h:'#ED2227', u:'Non-compliant border' },
    { n:'status/pending-bg',           a:'warning/100', h:'#FEF3C7', u:'Pending background' },
    { n:'status/pending-text',         a:'warning/500', h:'#D97706', u:'Pending text' },
    { n:'status/pending-border',       a:'warning/400', h:'#F59E0B', u:'Pending border' },
    { n:'status/expired-bg',           a:'danger/100', h:'#FFE5E5', u:'Expired background (remapped to danger)' },
    { n:'status/expired-text',         a:'danger/500', h:'#D70005', u:'Expired text (remapped to danger)' },
    { n:'status/expired-border',       a:'danger/400', h:'#ED2227', u:'Expired border (remapped to danger)' },
    { n:'status/review-bg',            a:'primary/100', h:'#EFF6FF', u:'Under-review background' },
    { n:'status/review-text',          a:'primary/500', h:'#1D4ED8', u:'Under-review text' },
    { n:'status/review-border',        a:'primary/400', h:'#2882FF', u:'Under-review border' },
    { n:'status/na-bg',                a:'neutral/100', h:'#EEEEEE', u:'N/A background' },
    { n:'status/na-text',              a:'neutral/400', h:'#777777', u:'N/A text' },
    { n:'status/na-border',            a:'neutral/200', h:'#CCCCCC', u:'N/A border' },
  ],

  TYPES: [
    { tok:'heading-1',   samp:'The quick brown fox jumps',                      spec:'Roboto ExtraBold · 32px · LH 100% · LS -1%', st:'font-size:32px;font-weight:800;line-height:1;letter-spacing:-0.01em' },
    { tok:'heading-2',   samp:'The quick brown fox jumps over the lazy dog',    spec:'Roboto SemiBold · 24px · LH 100% · LS 0',  st:'font-size:24px;font-weight:600;line-height:1' },
    { tok:'heading-3',   samp:'The quick brown fox jumps over the lazy dog.',   spec:'Roboto SemiBold · 16px · LH 100% · LS 0',  st:'font-size:16px;font-weight:600;line-height:1' },
    ...
    { tok:'link',        samp:'View details &#8594; Click here to continue',    spec:'Roboto Regular · 14px · underline · LH 140%', st:'font-size:14px;font-weight:400;text-decoration:underline;color:#2882FF;line-height:1.4' },
